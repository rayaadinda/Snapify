export const PHOTO_STRIP_TEMPLATES = [
  {
    ...
    background: 'white',
    styles: {
      container: 'bg-white p-2 w-[200px] pb-16 shadow-lg',
  ...
  },
  {
    ...
    background: 'gradient',
    styles: {
      container: 'bg-gradient-to-b from-pink-300 via-purple-300 to-indigo-400 p-2 w-[200px] pb-16 relative overflow-hidden shadow-lg',
  ...
  },
  {
    ...
    background: 'pattern',
    styles: {
      container: 'bg-[#FFD4E5] p-2 w-[200px] pb-16 relative overflow-hidden shadow-lg',
      photo: 'rounded-none mb-2 relative z-10',
      background: '#FFD4E5',
      decorations: [
  ...
  },
  {
    ...
    background: 'neon',
    styles: {
      container: 'bg-black p-2 w-[200px] pb-16 relative overflow-hidden border-[2px] border-[#00ff9d] shadow-lg',
      photo: 'rounded-none mb-2 relative z-10 border-[1px] border-[#00ff9d] shadow-[0_0_8px_#00ff9d]',
      background: '#000000',
      decorations: [
  ...
  },
  {
    ...
    background: 'cute',
    styles: {
      container: 'bg-gradient-to-b from-[#FFF5F5] to-[#FFE0E0] p-2 w-[200px] pb-16 relative overflow-hidden shadow-lg',
      photo: 'rounded-none mb-2 relative z-10',
      background: '#FFF5F5',
      decorations: [
